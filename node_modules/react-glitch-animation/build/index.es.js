...
var GlitchAnimation = function (_a) {
    ...
    var _e = __read(React.useState(isActive), 2), active = _e[0], setActive = _e[1];
    ...
    return (React.createElement("div", { className: "react-glitch-wrapper" },
        React.createElement("div", { className: active ? 'rect-glitch-text' : 'rect-glitch-text-clear-animation', "data-text": text }, text)));
};

export { GlitchAnimation };
