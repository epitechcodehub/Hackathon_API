...
var GlitchAnimation = function (_a) {
    var _b = _a.text, text = _b === void 0 ? 'Glitch Animation Effect' : _b, _c = _a.animationDurationMS, animationDurationMS = _c === void 0 ? 0 : _c, _d = _a.isActive, isActive = _d === void 0 ? true : _d;
    var _e = __read(React__default['default'].useState(isActive), 2), active = _e[0], setActive = _e[1];
    ...
    return (React__default['default'].createElement("div", { className: "react-glitch-wrapper" },
        React__default['default'].createElement("div", { className: active ? 'rect-glitch-text' : 'rect-glitch-text-clear-animation', "data-text": text }, text)));
};

exports.GlitchAnimation = GlitchAnimation;
